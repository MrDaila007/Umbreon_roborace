...
| GP12 | Digital input | Rotary encoder CLK |
| GP22 | Digital input | Rotary encoder DT |
...
```
 ...
 Servo ──│ GP10 PWM       GP13 │ ── Tachometer
   ESC ──│ GP11 PWM       GP12 │ ── Encoder CLK
         │                     │
         └─────────────────────┘

  4x TF-Luna uses:  GP2-GP5 (UART RX)
  6x VL53L0X uses:  GP6-GP9, GP14-GP15 (XSHUT) + GP20-GP21 (I2C1)
  OLED menu uses:    GP0-GP1 (shared I2C0), GP12 (CLK), GP19 (SW), GP22 (DT)
